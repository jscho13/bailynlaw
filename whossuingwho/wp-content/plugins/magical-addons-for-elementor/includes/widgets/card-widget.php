...
<?php
    ...
    public function _content_template() {
        ?>
        <# var iconHTML = elementor.helpers.renderIcon( view, settings.mg_card_btn_selected_icon, { 'aria-hidden': true }, 'i' , 'object' ),
		migrated = elementor.helpers.isIconMigrated( settings, 'mg_card_btn_selected_icon' );
        ...
        view.addInlineEditingAttributes( 'mg_card_btn_title', 'none' );
