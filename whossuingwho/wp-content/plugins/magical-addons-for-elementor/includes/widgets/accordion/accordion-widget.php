	...
	<?php if($mgac_items): ?>
		...
		<div class="card mgrc-item mgrc-item-<?php echo esc_attr($settings['mgac_text_align']); ?>-<?php echo esc_attr($settings['mgac_icon_position']); ?> text-<?php echo esc_attr($settings['mgac_text_align']); ?>">
		    <div class="card-header mg-accordion-title" id="heading<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>">
		        <div class="mgrc-title <?php if( $item['mgac_is_open'] != 'yes' ): ?>collapsed<?php endif; ?> <?php if($settings['mgac_icon_position'] == 'left'): ?>mgrc-left<?php endif; ?>" data-toggle="collapse" data-target="#mgc-item<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>" aria-expanded="<?php if( $item['mgac_is_open'] == 'yes'): ?>true<?php else: ?>false<?php endif; ?>" aria-controls="mgc-item<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>">
		    ...
		    <div id="mgc-item<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>" class="collapse mgaccont <?php if( $item['mgac_is_open'] == 'yes' ): ?>show<?php endif; ?>" aria-labelledby="heading<?php echo esc_attr($index); ?><?php echo esc_attr($mgac_rand); ?>" data-parent="#mgAccordion<?php echo esc_attr($mgac_rand); ?>">
