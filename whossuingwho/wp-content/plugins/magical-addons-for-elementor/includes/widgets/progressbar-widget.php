...
class MgProgressbar extends \Elementor\Widget_Base {
	...
	protected function register_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Percentage Text Typography', 'magical-addons-for-elementor' ),
				'scheme'   => \Elementor\Scheme_Typography::TYPOGRAPHY_1,
	...
	protected function render() {
		...
		<div class="mg-progress"
		 data-parcent-show="<?php echo esc_attr($mgp_parcent_show); ?>"
		 data-parcent="<?php echo esc_attr($mgp_parcent['size']); ?>"
		 data-barcolor="<?php echo esc_attr($bar_color); ?>"
		 data-trailcolor="<?php echo esc_attr($trail_color); ?>"
		 data-barheight="<?php echo esc_attr($bar_height['size']); ?>"
		 data-trailheight="<?php echo esc_attr($trail_height['size']); ?>"
		 data-strokewidth="<?php echo esc_attr($stroke_width['size']); ?>"
		 data-animation-time="<?php echo esc_attr($mgp_animation_time['size']); ?>"
		  ></div>
