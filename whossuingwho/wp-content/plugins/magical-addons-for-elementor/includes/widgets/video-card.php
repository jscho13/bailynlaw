	...
	<div class="mg-card-img mgvideo-thumb">
		<figure>
			...
			<?php echo \Elementor\Group_Control_Image_Size::get_attachment_image_html( $settings, 'thumbnail', 'mg_cvideo_thumb' ); ?>
			 <?php else: ?>
			 <img src="<?php echo esc_url('//img.youtube.com/vi/'.get_mg_youtube_id($settings['mg_vcard_video_url']).'/hqdefault.jpg');?>" 
			 alt="<?php esc_attr_e( 'Card Video','magical-addons-for-elementor' ); ?>" />
			 <?php endif; ?>
