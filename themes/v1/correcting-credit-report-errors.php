    ...
    <div class="sub-category-title">
      <div class="header_content_container" style="display:none;">
        <div class="yellow-box">
          <h1> Correcting Credit Report Errors
          </h1>
          <h2> </h2>
...
<section class="container">
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <p>
      For your free credit reports, don’t contact the reporting agencies individually, go to this site: <a class="plain-text-link" target="_blank" href="https://www.annualcreditreport.com/index.action"> https://www.annualcreditreport.com/index.action</a>
      </p>
      <p>
