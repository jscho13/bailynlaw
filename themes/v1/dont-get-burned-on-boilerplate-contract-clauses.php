    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1>Don't Get Burned On Boilerplate Contract Clauses
          </h1>
          <h2> </h2>
...
<section class="container">
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <h3 class="text-blue-header">LEGAL FEES PROVISIONS</h3>
      <p>
      ...
      <h3 class="text-blue-header">INDEMNIFICATION CLAUSES</h3>
      <p>
      ...
      <h3 class="text-blue-header">FORCE MAJEURE CLAUSES</h3>
      <p>
