    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1>Sole Proprietorship Chapter 11
          </h1>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <br>
        ...
        <li>Can a bankruptcy get me out of my lease entirely?</li>
        <li>I owe my landlord a lot of interest and fees on my back rent; is there any way to avoid paying that?</li>
        <li>Can I continue to operate my business during bankruptcy?</li>
        <li>Is bankruptcy the only way to restructure my business?</li>
      </ul>
      <p></p>
      <p>
      ...
      <h3 class="text-blue-header">Restructuring Under Chapter 11</h3>
      <p>
      ...
      <h3 class="text-blue-header">Does Chapter 11 make sense for your business?</h3>
      <p>
