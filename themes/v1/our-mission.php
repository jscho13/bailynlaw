...
<div id="" class="row short_row">
	<div class="col-12">
		...
		<div class="about_us_header-image-container">
			<img src="<?php echo DIR_HTTPS_CATALOG.DIR_IMAGES?>/bailyn-law-firm-header-image.jpg" alt="Bailyn Law Firm" title="Bailyn Law Firm" class="">
		</div>
	</div>
</div>
...
<section id="our-mission" class="padding">
	<div class="row">
		<h1 class="title">Direct Action To Protect Entrepreneurs And Strengthen Companies</h1>
		<h2 class="subtitle">Fast-Moving, Hard-Hitting Business Law And Commercial Litigation Counsel</h2>
		<hr class="hr-grey85">
	</div>
	<div class="row">
		<div class="col-md-8">
		
<p>My mission is to solve problems and resolve disputes for
entrepreneurs quickly, creatively and intelligently.</p>

<p>I understand that your company and/or property is your life's
investment. It is your retirement plan, your children's future and the
embodiment of everything you believe in wrapped up in one. In the case
of a company, it maybe all of those things for the employees, as well.
Many people are left physically ill by the feeling of helplessness as
they watch their lives go up in smoke as their legal counsel does
absolutely nothing to protect their interests. In this case the
situation rises to the level of a medical emergency.</p>

<p>If you're saying, "Yes, that's me!" it's because your situation is
unfortunately common. But the good news is that there are take-charge
lawyers out there who appreciate how much pressure you're under and
have the skills, experience and attitude to take some of that pressure
off.</p>
	
<h3 class="text-blue-header">Boarding Up The Windows</h3>	
<p>
...
<h3 class="text-blue-header">Direct Action When Your Company Or Property Are Under Attack</h3>
<p>
...
<h3 class="text-blue-header">Examples Of When To Call Us</h3>
<ul>
    <li>Your're a shareholder being denied your rights by a dominant shareholder who controls the board, refusing to hold meetings, elections and count the votes with transparency,
    </li>
	<li>
    ...
    You need proper documents drawn up to structure an investment or a new business.
		...
		<div class="col-md-4 about-us-side-bar">
			<div class="about-us-side-bar-image-container">
				<img src="<?php echo DIR_HTTPS_CATALOG.DIR_IMAGES?>/founder-bradley-r-bailyn-esq.jpg" class="" alt="Bradley R. Bailyn, Esq., Founder" title="Bradley R. Bailyn, Esq., Founder">
			</div>
			<h4>Bradley R. Bailyn, Esq., Founder and Lead Counsel</h4>
			<p>
