    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1>Do Jurisdiction Clauses Matter To NY Companies? More Than You Can Imagine... </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <h1 class="blog-header">
        Do Jurisdiction Clauses Matter To NY Companies? More Than You
        Can Imagine...
      </h1>
      <br>
      ...
      <hr>
      <iframe width="709" height="500" src="https://www.youtube.com/embed/HfXJHM8nh0Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
      ...
      <h3 class="text-blue-header">UNDERSTANDING YOUR CASE</h3>			
      <p>
      ...
      <h3 class="text-blue-header">THE LAW OF THE JURISDICTION</h3>
      <p>
      ...
      <p>
      Bradley Bailyn is a New York debtor/creditor attorney representing clients in commercial litigation, bankruptcy and out-of-court financial negotiations. Call 718-841-0025 for a no-cost consultation on your case.
      </p>
    </div>
