...
<section class="container">
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <br>
      <h2 class="blog-sub-header">
        Practical insights from powerhouse attorney, author and speaker <a class="plain-text-link" title="About Bradley Bailyn" href="https://bailynlaw.com/about-us">Bradley Bailyn.</a>
      </h2>
      <hr>
      <p>
      ...
      <h3 class="text-blue-header">What is a Stalking Horse Sale anyway?</h3>
      <p>
      ...
      <h3 class="text-blue-header">How do these sales work?</h3>
      <p>
      ...
      <h3 class="text-blue-header">Finding a Buyer</h3>
      <p>
      ...
      <h3 class="text-blue-header">The Stalking Horse Bid</h3>
      <p>
      ...
      <br>
        ...
        <li><strong>Expense Reimbursement</strong> – Likely the most common incentive enjoyed by stalking horse bidders is expense reimbursement. For large-scale purchases, the expenses a bidder will incur to facilitate the purchase and perform due diligence can be staggering. That’s why many purchase agreements require the debtor to repay the expenses of a stalking horse bidder if they are ultimately outbid.</li>  
        <li><strong>Break-up Fees</strong> – Expense reimbursement helps make a stalking horse bidder whole if they are ultimately outbid, but that leaves them back where they started after going through the enormous undertaking of putting the bid together. A break-up fee is an amount negotiated above and beyond any expenses designed to induce an investor to make a bid. Break-up fees are controversial, and not every jurisdiction allows them.</li>
        <li><strong>Bidding Guidelines</strong> – Another controversial incentive involves the stalking horse having a say in drafting the bidding procedure for the public auction. The stalking horse bidder will, of course, seek any advantage they can get. That’s problematic, as anything that discourages other bidders drags down the sale price. Creditors in particular are hostile to these incentives, and some jurisdictions require the debtor to draft the bidding guidelines in conjunction with the creditors’ committee before a stalking horse is selected.</li>
      </ul>

      <p></p>
      <h3 class="text-blue-header">Public Auction</h3>
      <p>
      ...
      <h3 class="text-blue-header">Are Stalking Horse Sales Fair to Creditors?</h3>
      <p>
      ...
      <h3 class="text-blue-header">Ensure Auction Procedures Stimulate Bidding</h3>
      <p>
      ...
      <h3 class="text-blue-header">Avoid Unreasonable Break-Up Fees</h3>
      <p>
      ...
      <h3 class="text-blue-header">Object to the Final Sale if Necessary</h3>
      <p>
    ...
    <div id="sub-category-sidebar" class="col-lg-4">
      <a class="plain-text-link" href="<?php echo SITE_URL?>/nyc-business-lawyers-corporate-attorneys-ma-buy-sell-due-diligence-bailyn-law/">
        <div class="sidebarContainer">
          <img src="<?php echo DIR_HTTPS_CATALOG.DIR_IMAGES?>/Contract-Drafting.png" width="100%" alt="Commercial Litigation Attorneys" title="Commercial Litigation Attorneys"> 
          <strong>Commercial Litigation Attorneys</strong>
          <p>We handle the full range of commercial
          disputes from negotiation to litigation and
          arbitration to debt collection and judgement
          enforcement. Our reputable firm focuses on
      ...
      <a class="plain-text-link" href="<?php echo SITE_URL?>/nyc-bankruptcy-lawyers-business-restructuring-chapter-7-11-13-attorneys/">
        <div class="sidebarContainer">
          ...
          we handle business and consumer cases. On the creditor side,
          we file claims to recover money and property owed and we
          litigate cases in bankruptcy court including fraudulent transfer
