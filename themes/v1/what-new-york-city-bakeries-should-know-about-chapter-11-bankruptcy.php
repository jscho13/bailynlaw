    ...
    <div class="sub-category-title">
      <div class="header_content_container" style="display:none;">
        <div class="yellow-box">
          <h1>What New York City Bakeries Should Know About Chapter 11 Bankruptcy
          </h1>
          <h2> </h2>
...
<section class="container">
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <h3 class="text-blue-header">Bakeries and Bankruptcy</h3>
      <p>
      ...
      <h3 class="text-blue-header">Restructuring your Bakery</h3>
      <p>
      ...
      <h3 class="text-blue-header">Other Creditors</h3>
      <p>
      ...
      <h3 class="text-blue-header">Structured Settlements vs. Chapter 11 Bankruptcy</h3>
      <p>
