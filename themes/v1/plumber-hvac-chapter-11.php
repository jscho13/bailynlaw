    ...
    <div class="sub-category-title">
      <div class="header_content_container" style="display:none;">
        <div class="yellow-box">
          <h1> What New York Plumbing And HVAC Contractors Should Know About Bankruptcy
          </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <br>
        ...
        <li>Would his creditors negotiate with him?</li>
        <li>Is it possible to reduce or eliminate the judgment against his business?</li>
        <li>Is any of this possible without filing bankruptcy?</li>
      </ul>		
      <p></p>
      <p>
      ...
      <h3 class="text-blue-header">Risk vs. Reward in the Plumbing and HVAC Industry</h3>
      <p>
      ...
      <h3 class="text-blue-header">The Time You Need to Restructure</h3>
      <p>
      ...
      <h3 class="text-blue-header">Dealing with Judgment Creditors</h3>
      <p>
      ...
      <h3 class="text-blue-header">Other Options: Structured Settlements vs. Chapter 11 Restructuring</h3>
      <p>
      ...
      <p>
      Questions? Don’t hesitate to contact the Bailyn Law Firm at <a href="tel:+17188410025">718-841-0025</a>
