		...
		<div class="sub-category-title">
			<div class="header_content_container" style="display:none;">
				<div class="yellow-box">
					<h1>I'm Thinking About Filing A Chapter 7 Proceeding, Can I Discharge My Income Tax Debt?
 </h1>
					<h2> </h2>
	...
	<div class="row">
		<div id="sub-category-article" class="col-lg-8">
			...
			<h1 class="blog-header">
				I'm Thinking About Filing A Chapter 7 Proceeding, Can I Discharge My Income Tax Debt?
			</h1>
			<br>
