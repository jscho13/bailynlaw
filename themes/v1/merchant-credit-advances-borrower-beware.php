    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1> Merchant Credit Advances - Borrower Beware
          </h1>
          <h2> </h2>
...
<section class="container">
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <p>		
      <strong>This is why it is crucial to obtain a review of the agreement by knowledgeable counsel before signing any MCA funding agreement. Because a merchant goes the MCA route to obtain quick financing, it is wise that he more quickly gets to an attorney for contract review prior to signing.	</strong>			
      </p>
      <p>
