		...
		<div class="sub-category-title">
			<div class="header_content_container">
				<div class="yellow-box">
					<h1>Making and Breaking Cases for Commercial Fraud in New York—The Deposition
</h1>
					<h2> </h2>
...
<section class="container">
	<div class="row">
		<div id="sub-category-article" class="col-lg-8">
			...
			<h1 class="blog-header">Making and Breaking Cases for Commercial Fraud in New York—The Deposition</h1>
			<br>
