    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1> Trucking Company Chapter 11
          </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <br>
        ...
        <li>Could a Chapter 11 filing help him avoid paying judgments against his company?</li>
        <li>Is there any way to lower his tax bill during the bankruptcy process?</li>
        <li>Would a Chapter 11 filing allow him to continue operating while he restructures?</li>
        <li>Is it possible to restructure without filing for bankruptcy protection?</li>
      </ul>
      <p></p>
      <p>
      ...
      <h3 class="text-blue-header">Volatility in the Transportation Industry</h3>
      <p>
      ...
      <h3 class="text-blue-header">The Road to Restructuring</h3>
      <p>
      ...
      <h3 class="text-blue-header">Tax Debt</h3>
      <p>
      ...
      <h3 class="text-blue-header">Judgment Creditors</h3>
      <p>
      ...
      <h3 class="text-blue-header">Restructuring Outside of Bankruptcy </h3>
      <p>
