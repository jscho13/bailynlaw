    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1>Making and Breaking Cases for Commercial Fraud in New York—The Elements of Commercial Fraud—Reasonable (Justifiable) Reliance
          </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <h1 class="blog-header">
        Making and Breaking Cases for Commercial Fraud in New York—The Elements of Commercial Fraud—Reasonable (Justifiable) Reliance
      </h1>
      <br>
      ...
      <hr>
      <p>
      “Inconceivable!”  The shyster Vizzini (played by Wallace Shawn) used that term often in the sweet 1987 movie “The Princess Bride.”  At one point, Mandy Patinkin’s character Inigo Montoya states, “You keep using that word. I do not think it means what you think it means.”
      </p>
      <p>
