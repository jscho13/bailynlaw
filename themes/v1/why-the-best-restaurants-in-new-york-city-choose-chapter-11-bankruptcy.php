    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1>Why The Best Restaurants In New York City Choose Chapter 11 Bankruptcy
          </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <br>
        ...
        <li>How much time would he get to renegotiate?</li>
        <li>Does his landlord have the ability to force an eviction even after bankruptcy is filed?</li>
        <li>Is it possible to restructure a business without filing for bankruptcy?</li>
      </ul>
      <p></p>
      <p>
      ...
      <h3 class="text-blue-header">The Restaurant Industry is no Stranger to Bankruptcy</h3>
      <p>
      ...
      <h3 class="text-blue-header">Restructuring your Restaurant </h3>
      <p>
      ...
      <h3 class="text-blue-header">Rent</h3>
      <p>
      ...
      <h3 class="text-blue-header">Creditors</h3>
      <p>
      ...
      <h3 class="text-blue-header">Taxes</h3>
      <p>
