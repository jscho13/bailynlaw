    ...
    <div class="sub-category-title">
      <div class="header_content_container">
        <div class="yellow-box">
          <h1> Recovering Your Leased Equipment In A New York Chapter 11 Bankruptcy Proceeding
          </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <h1 class="blog-header">
        Recovering Your Leased Equipment In A New York Chapter 11 Bankruptcy Proceeding
      </h1>
      <br>
      ...
      <h3 class="text-blue-header">Leases in Bankruptcy</h3>
      <p>
      ...
      <h3 class="text-blue-header">Is the lessor violating the terms of the lease?</h3>
      <p>
      ...
      <h3 class="text-blue-header">Motion for Relief from the Stay</h3>
      <p>
      ...
      <h3 class="text-blue-header">Getting Equipment Back Through the Replevin Process</h3>
      <p>
      ...
      <h3 class="text-blue-header">Steps to take to Protect Leased Equipment in a Bankruptcy Case</h3>
      <p>
      ...
      <h3 class="text-blue-header">Ensure leases are not technically purchase agreements</h3>
      <p>
      ...
      <h3 class="text-blue-header">Read notices carefully</h3>
      <p>
      ...
      <h3 class="text-blue-header">Hire an Experienced Creditor’s Rights Attorney</h3>
      <p>
