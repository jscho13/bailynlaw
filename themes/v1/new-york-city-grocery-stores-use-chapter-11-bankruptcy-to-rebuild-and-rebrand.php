...
<div id="" class="row short_row">
  <div class="sub-category-header">
    <div class="sub-category-title">
      <div class="header_content_container" style="display:none;">
        <div class="yellow-box">
          <h1>New York City Grocery Stores Use Chapter 11 Bankruptcy To Rebuild and Rebrand
          </h1>
          <h2> </h2>
  ...
  <div class="row">
    <div id="sub-category-article" class="col-lg-8">
      ...
      <h1 class="blog-header">
        New York City Grocery Stores Use Chapter 11 Bankruptcy To Rebuild and Rebrand
      </h1>
      <br>
      ...
      <br>
        ...
        <li>Would he be able to pay his employees?</li>
        <li>Would he be able to honor gift certificates and customer loyalty rewards?</li>
        <li>Does the bankruptcy process make it easier to negotiate with his creditors?</li>
        <li>Can’t he just work out new deals with his creditors without having to file bankruptcy?</li>
      </ul>
      <br>	
      ...
      <p></p>
      <h3 class="text-blue-header">Volatility in the Grocery Industry </h3>
      The unfortunate part about the growing trend of New York grocers filing for bankruptcy is that the industry was hoping a rebound was coming. Years of pricing wars had led to difficult margins, but the lowering price of food was supposed to usher in a more profitable era for grocery stores.
      <p></p>
      <p>
      It didn’t happen like that. Now, competition in the New York grocery market is more competitive than ever. International grocers are moving in and pushing prices down. Online competitors like Amazon are making moves to cut groceries out of the equation entirely.
      </p>
      <p>
      ...
      <h3 class="text-blue-header">Buying Time to Restructure</h3>
      <p>
      ...
      <h3 class="text-blue-header">Renegotiating with Creditors</h3>
      <p>
      ...
      <h3 class="text-blue-header">Renegotiating with Employees and Unions</h3>
      <p>
      ...
      <h3 class="text-blue-header">Protecting your Customers</h3>
      <p>
      ...
      <h3 class="text-blue-header">Loyalty Programs</h3>
      <p>
      ...
      <h3 class="text-blue-header">Gift Cards</h3>
      <p>
      ...
      <h3 class="text-blue-header">Structured Settlements vs. Chapter 11 Restructuring</h3>
      <p>
