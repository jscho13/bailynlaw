    ...
    <div class="postbox">
      ...
      <div class="inside">
        <dl class="accordion">
          ...
          <dd class="panel">
            <div class="panel-inner">
              <p><?php _e( 'For questions, please visit our <a href="//theme.co/x/member/kb/extension-google-analytics/" target="_blank">Knowledge Base tutorial</a> for this plugin.', '__tco__' ); ?></p>
            </div>
          </dd>
