...
use com\cminds\listmanager\plugin\frontend\walkers\LinkWalkerConstructionclassesorg as LinkWalker;

use com\cminds\listmanager\plugin\options\Options;



class CategoryWalkerConstructionclassesorg extends CategoryWalker {
    ...
    public function start_el(&$output, $category, $depth = 0, $args = array(), $id = 0) {
        ...
        if ($color) {
            ...
            // this is where I can add in an extra class 
            // the extra class is category sort to sort by date then by rank
            $output .= sprintf('<div class="cmlm-category categorySort" style="%s" data-id="%s" data-role="category">', $bonus_style, $category->term_id);
