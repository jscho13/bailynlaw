...
namespace com\cminds\package\pro\v1_9_0;
...
//                cminds_show_message( $this->message, $this->messageError );
        ...
        public function setMessage() {
            ...
            $licenseInfoRefreshLink = 'If you already renewed this license please <a class="button submit-btn submit-button" href="' . esc_attr(remove_query_arg('cminds_dismiss_notice', add_query_arg(array('check' => urlencode($this->pluginSlug))))) . '">click on this button</a>.';
