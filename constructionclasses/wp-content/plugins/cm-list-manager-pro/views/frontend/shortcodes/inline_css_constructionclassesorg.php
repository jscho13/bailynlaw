...
.cmlm-link-subtitle, .cmlm-link-event-date { 
    ...
    <?php if (Options::getOption('event_date_font_style')): ?>
        ...
        font-style: <?php echo Options::getOption('event_date_font_style'); ?>; 
...
.cmlm.constructionclassesorg .cmlm-link-subtitle{

    padding-left: 0;

}

.cmlm.constructionclassesorg .cmlm-category-link-list{
...
.cmlm a.cmlm-link:link, .cmlm a.cmlm-link:visited, .cmlm a.cmlm-link:focus{
...
.cmlm .cmlm-filter input[type="checkbox"]{
